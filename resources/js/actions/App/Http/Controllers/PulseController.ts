...
*/
export const storeStatement = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/pulse/statement'
*/
storeStatement.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeStatement.url(options),
    method: 'post',
})
...
* @route '/pulse/statement'
*/
const storeStatementForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/pulse/statement'
*/
storeStatementForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: storeStatement.url(options),
    method: 'post',
})
