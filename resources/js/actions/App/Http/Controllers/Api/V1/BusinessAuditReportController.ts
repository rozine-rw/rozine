...
/**
* @see \App\Http\Controllers\Api\V1\BusinessAuditReportController::operation
* @see app/Http/Controllers/Api/V1/BusinessAuditReportController.php:42
* @route '/api/v1/business/audit-report-operations/{request_id}'
*/
...
operation.definition = {
    methods: ["get","head"],
    url: '/api/v1/business/audit-report-operations/{request_id}',
