...
/**
* @see \App\Http\Controllers\BusinessApplicationController::operation
* @see app/Http/Controllers/BusinessApplicationController.php:95
* @route '/business/application-operations/{request_id}'
*/
...
operation.definition = {
    methods: ["get","head"],
    url: '/business/application-operations/{request_id}',
...
create.definition = {
    methods: ["post"],
    url: '/business/{business}/applications',
...
show.definition = {
    methods: ["get","head"],
    url: '/business/{business}/applications/{application}',
} satisfies RouteDefinition<["get","head"]>
...
save.definition = {
    methods: ["post"],
    url: '/business/{business}/applications/{application}/save',
} satisfies RouteDefinition<["post"]>
...
evaluate.definition = {
    methods: ["post"],
    url: '/business/{business}/applications/{application}/evaluate',
} satisfies RouteDefinition<["post"]>
...
submit.definition = {
    methods: ["post"],
    url: '/business/{business}/applications/{application}/submit',
} satisfies RouteDefinition<["post"]>
