...
if selected auditor-boundary; then
  ...
  for auditor_model in AuditorProfile AuditorProfileVersion AuditorCertificate AuditLocation AuditLocationVersion AuditorIndependenceReview AuditorIndependenceVersion; do
