 ...
 * @phpstan-type OperationsCase array{audit_reviews: list<array{report_id: string, status: string}>, id: string, business_id: string, revision: int, kind: string, status: string, original_dispatch_at: string, complete_by: string|null, attempt: int, operations_reason: string|null, closed_at: string|null, allowed_actions: list<string>}
