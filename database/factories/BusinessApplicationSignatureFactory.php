...
/** @extends Factory<BusinessApplicationSignature> */
class BusinessApplicationSignatureFactory extends Factory
{
    ...
    public function definition(): array
    {
        return ['business_application_quote_id' => BusinessApplicationQuote::factory(),
            ...
            'consent_release_id' => ConsentRelease::factory(), 'actor_party_id' => Party::factory(),
