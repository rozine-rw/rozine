...
### `audit_dispute_proofs`

| Column | Type | Nullable | Default |
|---|---|---|---|
| `id` | `bpchar` | no | — |
| `audit_report_publication_id` | `bpchar` | no | — |
| `audit_publication_event_id` | `bpchar` | no | — |
| `content` | `text` | no | — |
| `filename` | `text` | no | — |
...
**Indexes:** `audit_dispute_proofs_pkey` on (id) — unique
...
| `created_at` | `timestamptz` | yes | — |
| `updated_at` | `timestamptz` | yes | — |
| `policy_version` | `varchar` | no | `'audit-publication-legacy'::character varying` |
| `delivered_at` | `timestamptz` | yes | — |
| `due_at` | `timestamptz` | yes | — |
| `published_reason` | `varchar` | yes | — |
| `review` | `text` | yes | — |

**Indexes:** `audit_report_publications_audit_report_id_unique` on (audit_report_id) — unique; `audit_report_publications_pkey` on (id) — unique; `audit_review_due` on (policy_version, status, due_at)
...
| `business_id` | `bpchar` | no | — |
| `business_application_id` | `bpchar` | no | — |
| `business_application_submission_id` | `bpchar` | no | — |
...
| 2026_09_26_103442_add_monthly_audit_review_policy.php |
...
| GET | `/admin/audit-assignments/dispute-operations/{request_id}` | `staff.audit.disputes.operations.show` | `AuditDisputeController@operation` | web, auth, throttle:60,1, cache.headers:private;no_store |
...
| GET | `/admin/audit-assignments/{assignment}/reports/{report}/dispute` | `staff.audit.disputes.show` | `AuditDisputeController@show` | web, auth, throttle:60,1, cache.headers:private;no_store |
| POST | `/admin/audit-assignments/{assignment}/reports/{report}/dispute/escalate` | `staff.audit.disputes.escalate` | `AuditDisputeController@resolve` | web, auth, throttle:60,1, cache.headers:private;no_store |
...
| GET | `/api/v1/auditor/reports/{report}/dispute/proofs/{proof}` | `api.v1.auditor.reports.disputes.proofs.show` | `AuditDisputeController@proof` | api, auth:sanctum, throttle:60,1, cache.headers:private;no_store |
| POST | `/api/v1/auditor/reports/{report}/dispute/uphold` | `api.v1.auditor.reports.disputes.uphold` | `AuditDisputeController@uphold` | api, auth:sanctum, throttle:60,1, cache.headers:private;no_store |
...
| POST | `/api/v1/business/{business}/audit-reports/{report}/dispute` | `api.v1.business.audit-reports.dispute` | `AuditDisputeController@dispute` | api, auth:sanctum, throttle:60,1, cache.headers:private;no_store |
...
| GET | `/api/v1/staff/audit-assignments/dispute-operations/{request_id}` | `api.v1.staff.audit.disputes.operations.show` | `AuditDisputeController@operation` | api, auth:sanctum, throttle:60,1, cache.headers:private;no_store |
...
| GET | `/api/v1/staff/audit-assignments/{assignment}/reports/{report}/dispute` | `api.v1.staff.audit.disputes.show` | `AuditDisputeController@show` | api, auth:sanctum, throttle:60,1, cache.headers:private;no_store |
...
| GET | `/auditor/reports/{report}/dispute/proofs/{proof}` | `auditor.reports.disputes.proofs.show` | `AuditDisputeController@proof` | web, auth, throttle:60,1, cache.headers:private;no_store |
| POST | `/auditor/reports/{report}/dispute/uphold` | `auditor.reports.disputes.uphold` | `AuditDisputeController@uphold` | web, auth, throttle:60,1, cache.headers:private;no_store |
...
| POST | `/business/{business}/audit-reports/{report}/dispute` | `business.audit-reports.dispute` | `AuditDisputeController@dispute` | web, auth, throttle:60,1, cache.headers:private;no_store |
