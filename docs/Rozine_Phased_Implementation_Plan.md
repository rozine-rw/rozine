...
**Current start condition, 2026-09-23:** The remaining MVP behavioral/default choices and shared specification are baselined in [engineering-2026-09-23.4](phase-0/engineering-contract-draft-2026-09-20.md) section 11. Erastus's current specification review is waived by Aminu, not performed. No further joint-freeze review is required for this baseline. Phase 1 implementation has not been started or authorized by this defaults-only update; remaining Phase 0 evidence, including #90, is tracked separately from design choices. Original operational/external evidence in the [earlier consolidation](phase-0/stakeholder-policy-consolidation-2026-09-20.md) is not fabricated by selecting defaults. The earlier three-question follow-up is superseded and must not be treated as still awaiting those answers.
