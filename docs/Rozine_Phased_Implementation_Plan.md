...
- [ ] Integrate checkpoint 2: Business application, statement parsing, underwriting, and Auditor filing. **IN PROGRESS — implementation started on `codex/phase-1-checkpoint-two`, based on the merged checkpoint 1.**
  ...
  - [ ] Establish scoped staff operations, current verified entity/mandate authority and versioned consent; preserve person-level role isolation and prohibit tax identifiers.
  ...
  - [ ] Implement resumable Business onboarding/application actions, shared web/API Resources and live Business screens using deterministic verification/provider adapters for isolated Alpha.
  ...
  - [ ] Retain original statements and hashes, parse and reconcile all declared rails, append corrections and immutable verified monthly snapshots; expose parsing feedback and actionable denials.
  ...
  - [ ] Implement the current engineering-2026-09-23.4 exact-money scorecard, pricing, 36/12-month evidence rules, initial-request cutoff, final DSCR, repeat projections, exposure and RWF 5,000 offer quantization, with immutable replayable calculations and acceptance authority.
