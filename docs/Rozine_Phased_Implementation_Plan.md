...
**Start condition reaffirmed 2026-09-20:** The user requires outstanding behavioral decisions and shared contracts to be resolved before Phase 1 development. No preparatory-slice exception is approved for this work. Keep development on hold until the joint contract freeze and the remaining Phase 0 exit gate in the [current consolidation](phase-0/stakeholder-policy-consolidation-2026-09-20.md) are verified; the existing foundation status is not permission to start. The earlier three-question follow-up is superseded and must not be treated as still awaiting those answers.
